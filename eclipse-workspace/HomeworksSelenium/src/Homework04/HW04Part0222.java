...
public class HW04Part0222 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		List<WebElement> RB = driver.findElements(By.cssSelector("input.custom-control-input[type='radio']"));
		System.out.println(RB.size());
		
		
		Thread.sleep(200);
		
		for (WebElement e1 : RB) {
	          if(e1.isEnabled())
	          {
...
//		if (YesRB1 == true) {
//			System.out.println("Radio buttons has been clicked successfully");
//		} else if (YesRB1 == false){
//			System.out.println("Failed to click radio buttons");
//		}else {
